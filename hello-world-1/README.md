...
- `run-app.bat` - Windows launch script for local development.

---
## Run locally on Windows

A local Windows launch script is included at `run-app.bat`.

1. Open a command prompt in the repo root (`d:\CODING\hello-world-1`).
2. Run `run-app.bat`.
...
- open your default browser at `http://127.0.0.1:8000/`
